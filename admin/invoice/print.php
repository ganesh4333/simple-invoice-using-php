...
<h1 class="text-center"><b>ESTIMATION</b></h1>
<table class="table">
    <colgroup>
        <col width="50%">
        <col width="50%">
    ...
    <tr>
        ...
        <td>
        <p><b>Estimation Date:</b> <?php echo date("F d, Y",strtotime($date_created)) ?></p>
        <p><b>Estimation Code:</b> <?php echo $invoice_code ?></p>
        </td>
    </tr>
</table>
<hr>
<table class="table table-bordered">
    ...
    <thead>
        <tr>
            ...
            <th class="text-center">Materials Required</th>
    ...
    <tfoot>
        ...
        <tr class="bg-foot" style="background-color:#95b3e8 !important;">
            ...
            <th class="text-right" id="sub_total"><?php echo number_format($shipping) ?></th>
        </tr>
        <tr class="bg-foot" style="background-color:#95b3e8 !important;">
            <th class="text-right" colspan="4">SGST</th>
            <th class="text-right" id="tax_rate"><?php echo ($tax_rate)/2 ?>%</th>
        </tr>
        <tr class="bg-foot" style="background-color:#95b3e8 !important;">
