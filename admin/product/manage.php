...
<div class="container-fluid">
	<form action="" id="product-form">
		...
		<!-----rack--->
		<div class="form-group">
			<label for="product" class="control-label">Rack ID</label>
			<textarea name="rackid" id="product" cols="30" rows="1" class="form-control form no-resize"><?php echo isset($rackid) ? $rackid : ''; ?></textarea>
		</div>
		
		<div class="form-group">
			<label for="product" class="control-label">Quantity</label>
			<textarea name="quantity" id="product" cols="30" rows="1" class="form-control form no-resize"><?php echo isset($quantity) ? $quantity : ''; ?></textarea>
		</div>
